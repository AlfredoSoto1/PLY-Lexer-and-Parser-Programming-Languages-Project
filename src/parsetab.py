...
_lr_productions = [
  ...
  ('prog -> decl_list stmt_list','prog',2,'p_prog','Lexical-Asignacion.py',152),
  ('decl_list -> empty','decl_list',1,'p_decl_list','Lexical-Asignacion.py',156),
  ('decl_list -> decl_list decl','decl_list',2,'p_decl_list','Lexical-Asignacion.py',157),
  ('empty -> <empty>','empty',0,'p_empty','Lexical-Asignacion.py',162),
  ('decl -> type var_list S','decl',3,'p_decl','Lexical-Asignacion.py',166),
  ('stmt_list -> stmt_list stmt','stmt_list',2,'p_stmt_list','Lexical-Asignacion.py',170),
  ('stmt_list -> stmt','stmt_list',1,'p_stmt_list','Lexical-Asignacion.py',171),
  ('stmt -> IF RO exp RC stmt','stmt',5,'p_stmt','Lexical-Asignacion.py',176),
  ('stmt -> ELSE stmt','stmt',2,'p_stmt','Lexical-Asignacion.py',177),
  ('stmt -> WHILE RO exp RC stmt','stmt',5,'p_stmt','Lexical-Asignacion.py',178),
  ('stmt -> assignment','stmt',1,'p_stmt','Lexical-Asignacion.py',179),
  ('stmt -> PRINT exp S','stmt',3,'p_stmt','Lexical-Asignacion.py',180),
  ('stmt -> BO stmt_list BC','stmt',3,'p_stmt','Lexical-Asignacion.py',181),
  ('assignment -> id S','assignment',2,'p_assignment','Lexical-Asignacion.py',186),
  ('assignment -> id EQ exp S','assignment',4,'p_assignment','Lexical-Asignacion.py',187),
  ('type -> INT_TYPE','type',1,'p_type','Lexical-Asignacion.py',192),
  ('type -> DOUBLE_TYPE','type',1,'p_type','Lexical-Asignacion.py',193),
  ('var_list -> var','var_list',1,'p_var_list','Lexical-Asignacion.py',198),
  ('var_list -> var_list CM var','var_list',3,'p_var_list','Lexical-Asignacion.py',199),
  ('var -> ID array','var',2,'p_var','Lexical-Asignacion.py',204),
  ('array -> empty','array',1,'p_array','Lexical-Asignacion.py',208),
  ('array -> array SO INT SC','array',4,'p_array','Lexical-Asignacion.py',209),
  ('id -> ID','id',1,'p_id','Lexical-Asignacion.py',214),
  ('id -> ID SO INT SC','id',4,'p_id','Lexical-Asignacion.py',215),
  ('id -> ID SO ID SC','id',4,'p_id','Lexical-Asignacion.py',216),
  ('exp -> exp AND exp','exp',3,'p_exp','Lexical-Asignacion.py',221),
  ('exp -> exp OR exp','exp',3,'p_exp','Lexical-Asignacion.py',222),
  ('exp -> NOT exp','exp',2,'p_exp','Lexical-Asignacion.py',223),
  ('exp -> exp EQ EQ exp','exp',4,'p_exp','Lexical-Asignacion.py',224),
  ('exp -> exp MIN exp','exp',3,'p_exp','Lexical-Asignacion.py',225),
  ('exp -> exp MAJ exp','exp',3,'p_exp','Lexical-Asignacion.py',226),
  ('exp -> exp MAJ_EQ exp','exp',3,'p_exp','Lexical-Asignacion.py',227),
  ('exp -> exp MIN_EQ exp','exp',3,'p_exp','Lexical-Asignacion.py',228),
  ('exp -> exp PLUS exp','exp',3,'p_exp','Lexical-Asignacion.py',229),
  ('exp -> exp MINUS exp','exp',3,'p_exp','Lexical-Asignacion.py',230),
  ('exp -> exp STAR exp','exp',3,'p_exp','Lexical-Asignacion.py',231),
  ('exp -> exp DIV exp','exp',3,'p_exp','Lexical-Asignacion.py',232),
  ('exp -> RO exp RC','exp',3,'p_exp','Lexical-Asignacion.py',233),
  ('exp -> exp INT','exp',2,'p_exp','Lexical-Asignacion.py',234),
  ('exp -> exp DOUBLE','exp',2,'p_exp','Lexical-Asignacion.py',235),
